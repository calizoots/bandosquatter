...
import { UserData } from '../types/bludclart';
...
let oblockpage = () => {
    ...
    return (
        <>
            <span className="settings-go-back" onClick={() => (window.location.href = '/bludclart')}>
                go back?
            </span>
                    ...
                    <div className="roach">
                        {isUserNameMenu ? (
                            <div className="settings-change-user-name-menu">
                                ...
                                <button
                                    className="settings-change-user-name-menu-submit"
                                    onClick={async () => {
                                        if (usernameInput == '') {
                        ...
                        <div className="goverment">
                            <div
                                className="sugar"
                                onClick={() => {
                                    setPictureMenuVisiblity(!isPictureMenu);
                                }}
                            >
                            ...
                            <div
                                className="bang"
                                onClick={() => {
                                    setUserNameMenuVisibility(!isUserNameMenu);
                                }}
                            >
                        ...
                        {isPictureMenu ? (
                            <div className="settings-change-profile-picutre-menu">
                                <span className="settings-change-profile-picutre-menu-label">enter a sik picture m8</span>
                                <input
                                    placeholder="yo img ere"
                                    className="settings-change-profile-picutre-menu-input"
                                    onInput={e => setProfilePictureInput(e.currentTarget.value)}
                                />
                                <button
                                    className="settings-change-profile-picutre-menu-submit"
                                    onClick={async () => {
