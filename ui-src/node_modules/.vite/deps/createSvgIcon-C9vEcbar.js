import { Q, _, k } from "./preact.module-BwYZUE7d.js";
import { A, _ as _$1, x } from "./hooks.module-Cpqs4nXr.js";
import { D, I, M, mn } from "./compat.module-C_tmyNQi.js";
import { u } from "./jsxRuntime.module-DC4gEk8z.js";
...
var require_factoryWithTypeCheckers = /* @__PURE__ */ __commonJS({ "node_modules/prop-types/factoryWithTypeCheckers.js": ((exports, module) => {
	...
	module.exports = function(isValidElement, throwOnDirectAccess$1) {
		...
		*/
		function is(x$1, y) {
			if (x$1 === y) return x$1 !== 0 || 1 / x$1 === 1 / y;
			else return x$1 !== x$1 && y !== y;
		}
		/**
...
function deepClone(source) {
	if (/* @__PURE__ */ mn(source) || (0, import_react_is$1.isValidElementType)(source) || !isPlainObject(source)) return source;
	const output = {};
...
function deepmerge(target, source, options = { clone: true }) {
	...
	if (isPlainObject(target) && isPlainObject(source)) Object.keys(source).forEach((key) => {
		if (/* @__PURE__ */ mn(source[key]) || (0, import_react_is$1.isValidElementType)(source[key])) output[key] = source[key];
...
function ruleset(value, root, parent, index, offset, rules, points, type, props, children, length$1) {
	...
	for (var i = 0, j = 0, k$1 = 0; i < index; ++i) for (var x$1 = 0, y = substr(value, post + 1, post = abs(j = points[i])), z = value; x$1 < size; ++x$1) if (z = trim(j > 0 ? rule[x$1] + " " + y : replace(y, /&\f/g, rule[x$1]))) props[k$1++] = z;
...
function murmur2(str) {
	...
	for (; len >= 4; ++i, len -= 4) {
		...
		k$1 ^= k$1 >>> 24;
		h = (k$1 & 65535) * 1540483477 + ((k$1 >>> 16) * 59797 << 16) ^ (h & 65535) * 1540483477 + ((h >>> 16) * 59797 << 16);
	}
	switch (len) {
...
var useInsertionEffectWithLayoutFallback = useInsertionEffect || _$1;

//#endregion
//#region node_modules/@emotion/react/dist/emotion-element-489459f2.browser.development.esm.js
var EmotionCacheContext = /* @__PURE__ */ Q(typeof HTMLElement !== "undefined" ? /* @__PURE__ */ createCache({ key: "css" }) : null);
...
var Emotion = /* @__PURE__ */ withEmotionCache(function(props, cache, ref) {
	...
	return /* @__PURE__ */ _(k, null, /* @__PURE__ */ _(Insertion$2, {
		cache,
		serialized,
...
var jsx = function jsx$1(type, props) {
	var args = arguments;
	if (props == null || !hasOwn.call(props, "css")) return _.apply(void 0, args);
		...
		switch (typeof arg$1) {
			...
			case "object":
				if (Array.isArray(arg$1)) toAdd = classnames$1(arg$1);
					...
					toAdd = "";
					for (var k$1 in arg$1) if (arg$1[k$1] && k$1) {
						toAdd && (toAdd += " ");
						toAdd += k$1;
					}
				}
...
var ClassNames = /* @__PURE__ */ withEmotionCache(function(props, cache) {
	...
	hasRendered = true;
	return /* @__PURE__ */ _(k, null, /* @__PURE__ */ _(Insertion$1, {
		cache,
		serializedArr
	}), ele);
});
...
var createStyled$1 = function createStyled$2(tag, options) {
	...
	return function() {
		...
		var Styled = withEmotionCache(function(props, cache, ref) {
			...
			newProps.className = className;
			if (ref) newProps.ref = ref;
			return /* @__PURE__ */ _(k, null, /* @__PURE__ */ _(Insertion, {
				cache,
				serialized,
				isStringTag: typeof FinalTag === "string"
			}), /* @__PURE__ */ _(FinalTag, newProps));
		});
...
function isObjectEmpty(object) {
	for (const _$2 in object) return false;
	return true;
}
...
function hslToRgb(color$1) {
	...
	const f = (n, k$1 = (n + h / 30) % 12) => l - a * Math.max(Math.min(k$1 - 3, 9 - k$1, 1), -1);
	let type = "rgb";
	const rgb = [
		Math.round(f(0) * 255),
		Math.round(f(8) * 255),
...
var PropsContext = /* @__PURE__ */ Q(void 0);
...
var defaultDarkOverlays = [...Array(25)].map((_$2, index) => {
...
var excludeVariablesFromRoot = (cssVarPrefix) => [
	...[...Array(25)].map((_$2, index) => `--${cssVarPrefix ? `${cssVarPrefix}-` : ""}overlays-${index}`),
...
function DefaultPropsProvider(props) {
	return /* @__PURE__ */ u(DefaultPropsProvider_default, { ...props });
}
...
var SvgIcon = /* @__PURE__ */ D(function SvgIcon$1(inProps, ref) {
	...
	return /* @__PURE__ */ u(SvgIconRoot, {
		...
		ownerState,
		children: [hasSvgAsChild ? children.props.children : children, titleAccess ? /* @__PURE__ */ u("title", { children: titleAccess }) : null]
	});
});
SvgIcon.propTypes = {
...
function createSvgIcon(path, displayName) {
	function Component(props, ref) {
		return /* @__PURE__ */ u(SvgIcon_default, {
...
//# sourceMappingURL=createSvgIcon-C9vEcbar.js.map